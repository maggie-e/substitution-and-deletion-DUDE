# Copied from https://stackoverflow.com/questions/23292242/converting-to-not-from-ipython-notebook-format
...
sourceFile = "denoise_maggie.py"     # <<<< change
destFile = "deletion_denoise.ipynb"    # <<<< change
